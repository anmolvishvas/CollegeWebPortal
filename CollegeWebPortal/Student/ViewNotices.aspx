<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewNotices.aspx.cs" Inherits="CollegeWebPortal.StudentArea.ViewNotices" Title="Notices" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-card p-3 mb-3">
        <div class="d-flex gap-2">
            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search notices..." />
            <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-primary" OnClick="btnSearch_Click" />
            <asp:Button ID="btnAll" runat="server" Text="All" CssClass="btn btn-outline-secondary" OnClick="btnAll_Click" />
        </div>
    </div>
